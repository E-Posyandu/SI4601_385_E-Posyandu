...
<main>
    <div class="container-fluid px-4 mt-4">
        ...
        <div class="mb-3 text-end">
            <a href="{{ route('kunjungan.create') }}" class="btn btn-success" dusk="tambah-visited">+ Tambah Kunjungan</a>
        </div>
                    ...
                    <tbody>
                        @forelse ($visiteds as $index => $visit)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('kunjungan.edit', $visit->id_kunjungan) }}" dusk=edit-visited class="btn btn-sm btn-warning">Edit</a>

                                    <form action="{{ route('kunjungan.destroy', $visit->id_kunjungan) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                        @csrf
                                        @method('DELETE')
