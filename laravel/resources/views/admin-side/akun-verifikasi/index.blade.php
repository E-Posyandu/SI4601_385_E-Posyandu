            ...
            <div class="search-box me-3">
                <form action="{{ route('verifikasi-akun.index') }}" method="GET">
                    <div class="input-group">
                        <input type="text" class="form-control" name="search" dusk="search-input" placeholder="Cari nama/email/NIK..."
                               value="{{ request('search') }}">
                        <button class="btn btn-outline-secondary" type="submit" dusk="search-button">
