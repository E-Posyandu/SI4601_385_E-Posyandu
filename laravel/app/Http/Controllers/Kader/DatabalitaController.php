...
class DatabalitaController extends Controller
{
    ...
    public function index(Request $request) 
    {
        ...
        return view('kader-side.data-balita.index', compact('balita'));
    }
    ...
    public function create() {
        ...
        return view('kader-side.data-balita.create', compact('orangtuas'));
    }
    ...
    public function show($id) 
    {
        ...
        return view('kader-side.data-balita.show', compact('balita', 'kunjungan', 'labels', 'berat', 'tinggi', 'lingkar'));
    }
