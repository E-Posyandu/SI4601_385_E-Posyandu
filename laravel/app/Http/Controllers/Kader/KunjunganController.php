...
{ 
    ...
    public function index(Request $request)
    {
        ...
        return view('kader-side.kunjungan.index', compact('visiteds'));
    }
    ...
    public function create()
    {
        ...
        return view('kader-side.kunjungan.create', compact('balitas','posyandus', 'petugas_kaders'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kunjungan.index')->with('success', 'Data berhasil ditambahkan');
    }
    ...
    public function show($id_balita)
    {
        ...
        return view('kader-side.kunjungan.show', compact('visited'));
    }
    ...
    public function edit($id)
    {
        ...
        $balitas = Balita::all();
        return view('kader-side.kunjungan.edit', compact('visited', 'balitas'));
    }
